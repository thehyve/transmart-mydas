    ...
    private def getCohortMafFeature = { VcfValues val ->
        ...
        [new DasFeature(
                ...
                ["RefSNP=${val.rsId}",
                        ...
                        "AlleleCount=${val.additionalInfo['AC'] ?: 'n/a'}",
                        "AlleleFrequency=${val.additionalInfo['AF'] ?: 'n/a'}",
                        "TotalAllele=${val.additionalInfo['AN'] ?: 'n/a'}",
                        "VariantClassification=${val.additionalInfo['VC'] ?: 'n/a'}"]*.toString(),
                        //links
                linkMap,
                //targets
                [],
    ...
    private def getSummaryMafFeature = { VcfValues val ->
        ...
        [new DasFeature(
                ...
                ["RefSNP=${val.rsId}",
                        ...
                        "AlleleFrequency=${val.additionalInfo['AF'] ?: 'n/a'}",
                        "TotalAllele=${val.additionalInfo['AN'] ?: 'n/a'}",
                        "BaseQRankSum=${val.additionalInfo['BaseQRankSum'] ?: 'n/a'}",
                        "MQRankSum=${val.additionalInfo['MQRankSum'] ?: 'n/a'}",
